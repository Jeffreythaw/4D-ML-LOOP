...
class MatrixComputationCore:
    ...
    def run_all_static_engines(self, src_vectors: np.ndarray, day_type: str) -> Dict[str, np.ndarray]:
        ...
        return {
            ENGINE_1_NAME: self.engine1.predict_vectors(src_vectors, day_type),
            ENGINE_2_NAME: self.engine2.predict_vectors(src_vectors, day_type),
            ENGINE_3_NAME: self.engine3.predict_vectors(src_vectors, day_type),
        }
